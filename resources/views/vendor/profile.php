<?php
  ...
  $store_banner = !empty($store_details['store_banner']) ? $store_details['store_banner'] : './uploads/default_img.png';
  $store_logo = !empty($store_details['store_logo']) ? $store_details['store_logo'] : './uploads/default_profile.webp';
  ...
  $varified = $usersTable['verified'] ? "<span class='verified-badge'>varified</span>" : "<span class='verified-badge bg-red-500'>unvarified</span>";
  // $varified = 564;
...
<body class="bg-gray-50 font-sans">
  <div class="flex min-h-screen">
    ...
    <aside id="aside" class="w-64 bg-gray-900 text-white p-4" style="z-index: 1010;">
      <div class="flex flex-col items-center">
        ...
        <?php if ($basic_info['profile_visibility']) 
              ...
              else echo "<span class='active-button mt-1 bg-red-500 px-2 rounded-full'> Offline </span>";
        ?>
      ...
      <div class="profile-header p-2 rounded-lg shadow flex items-center justify-center">
        <div class="flex items-center space-x-4">
          <div class="bg-green-400 p-[1px] rounded-full">
            <img src="<?php echo $store_logo; ?>" alt="Store Logo" class="rounded-full w-16 h-16">
          ...
          <div>
            ...
            <!-- <span class="verified-badge bg-red-500"><?php echo $varified; ?></span> -->
             <?php echo $varified; ?>
          ...
          <p class="grid grid-cols-[1fr_2fr] border-b-2 boder-gray-100 py-2">
            ...
            <span>
              <?php if (!empty($return_policy) || !empty($return_policy_file)): ?>
                <a href="<?php echo !empty($return_policy_file) ? './uploads/' . $return_policy_file : '#'; ?>" 
              ...
              <?php if (!empty($shipping_policy) || !empty($shipping_policy_file)): ?>
                <a href="<?php echo !empty($shipping_policy_file) ? './uploads/' . $shipping_policy_file : '#'; ?>" 
