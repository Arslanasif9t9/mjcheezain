    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-6">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">Replacement Requests</h1>
                    <p class="text-gray-600 mt-2">Manage and track all replacement requests for your products</p>
                </div>
                
                <div class="relative w-1/3">
                    <i class="fa-solid fa-magnifying-glass absolute left-4 top-3.5 text-gray-400"></i>
                    <input id="searchInput" type="text" placeholder="Search replacements..." 
                           class="border border-gray-300 px-12 py-3 rounded-xl w-full focus:outline-none focus:ring-3 focus:ring-blue-500/30 focus:border-blue-500 bg-white shadow-sm">
                    <button class="absolute right-3 top-2.5 bg-blue-600 text-white p-2 rounded-lg hover:bg-blue-700 transition">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="stat-card bg-white p-5 rounded-xl border-l-4 border-purple-500 card">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <div class="stat-card bg-white p-5 rounded-xl border-l-4 border-red-500 card">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm mb-1">Cancelled</p>
