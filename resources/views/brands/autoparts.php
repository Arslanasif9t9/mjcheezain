...
<body class="bg-gray-200">
    ...
    <div class="hero-header hero-bg" style="z-index: 10;">
        ...
        <div class="flex flex-col items-center justify-center text-center w-[100vw] h-[100vh] pb-0" style="z-index: 20;">
            <h1 class="text-white text-3xl md:text-4xl mb-1 px-4">Find Genuine Japan Auto Parts</h1>
            <p class="mb-8 text-gray-300 px-4">Thousands of certified parts—delivered nationwide in 3–5 days.</p>
            <div class="w-full max-w-4xl px-4">
                <div class="bg-white rounded-md p-2 grid grid-cols-[5fr_3fr_3fr_3fr] md:grid-cols-7 gap-2 text-black" style="z-index: 30;">
                    <input type="text" id="model" name="model" placeholder="Car Make/Model"
    ...
    <section class="current-sol-items bg-white mt-[-60px] mb-4 p-4 max-w-[78vw] mx-auto" id="search-section" style="display: none;">
        ...
        <div class="text-center py-8 text-gray-500">
            Search for auto parts to see results here
        </div>
    </section>

    <!-- car engines  -->
    <section class="car-engines bg-gray-100" >
        <h2>Car Engines</h2>
        <div class="container">
            <a href="">
                <img src="../img/Suzuki.png" alt="">
                <p>Suzuki</p>
            </a>
            <a href="">
            ...
            <a href="">
                <img src="../img/BYD.png" alt="">
                <p>BYD</p>
            </a>
            <a href="">
                <img src="../img/changan.png" alt="">
                <p>Changan</p>
            </a>
            <a href="">
            ...
            <a href="">
                <img src="../img/Tyota.png" alt="">
                <p>Toyota</p>
            </a>
            <a href="">
                <img src="../img/porche.png" alt="">
                <p>Porche</p>
            </a>
            <a href="">
    ...
    <?php
        ...
        function displayProductsByCategory($conn, $category) {
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<img src="../vendor/'.(!empty($row['image_path']) ? $row['image_path'] : $defaultImage).'" width="100%" height="100%" alt="'.$row['name'].'">';
        ...
        function displayPopularAutoParts($conn) {
            ...
            $sql = "SELECT vp.*, vpi.image_path, COUNT(o.id) as order_count
                    ...
                    WHERE vp.category = 'Auto Parts & Accessories' 
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<a href="product-details.php?id='.$row['id'].'" class="w-56 flex-shrink-0">';
                    echo '<img src="../vendor/'.(!empty($row['image_path']) ? $row['image_path'] : $defaultImage).'" alt="'.$row['name'].'">';
                    echo '<p class="my-1 h-8 overflow-hidden leading-4 line-clamp-2">'.$row['name'].'</p>';
                    echo '<p class="my-1">Instant decision <span class="text-[#c50] font-bold">'.$row['selling_price'].' PKR</span></p>';
    ...
    <div class="main-con">
        ...
        <section class="popular-brands bg-white ml4 p-4 -[78vw] m-auto">
            <h2 class="font-bold">Popular Auto Parts</h2>
        ...
        <section class="current-sold-items col-span-2 bg-white p-4 -[78vw] m-auto">
            <h2 class="font-bold mb-4">Engine Parts</h2>
            <div class="pupular-con relative">
                <button
                    class="left-btn absolute left-[-15px] top-[50%] translate-y-[-50%] bg-white  border-black border-2 rounded-full w-[40px] h-[40px]"><i
                        class="fa-solid fa-arrow-left text-xl"></i></button>
                <div class="w-100 border-[red] border-0 overflow-hidden" style="width: 78vw !important;">
                    <div class="test flex gap-8 overflow-x-auto w-max">
                        <?php displayProductsByCategory($conn, "Engine Parts"); ?>
                    </div>
                </div>
                <button
        ...
        <section class="current-sold-items col-span-2 bg-white mt0 p-4 -[78vw] m-auto">
            <h2 class="font-bold mb-4">Brake System</h2>
            <div class="pupular-con relative">
                <button
                    class="left-btn absolute left-[-15px] top-[50%] translate-y-[-50%] bg-white  border-black border-2 rounded-full w-[40px] h-[40px]"><i
                        class="fa-solid fa-arrow-left text-xl"></i></button>
                <div class="w-100 border-[red] border-0 overflow-hidden" style="width: 78vw !important;">
                    <div class="test flex gap-8 overflow-x-auto w-max">
                        <?php displayProductsByCategory($conn, "Brakes & Brake Parts"); ?>
                    </div>
                </div>
                <button
                    class="right-btn absolute right-[-15px] top-[50%] translate-y-[-50%] bg-white  border-black border-2 rounded-full w-[40px] h-[40px]"><i
        ...
        <!-- Suspension & Steering  -->
        <section class="pickup bg-white col-span-2 p-4 -[78vw] m-auto">
            <h2 class="font-bold mb-4">Suspension & Steering</h2>
            <div class="pupular-con relative">
                <button
                    class="left-btn absolute left-[-15px] top-[50%] translate-y-[-50%] bg-white  border-black border-2 rounded-full w-[40px] h-[40px]"><i
                        class="fa-solid fa-arrow-left text-xl"></i></button>
                <div class="w-100 border-[red] border-0 overflow-hidden" style="width: 78vw !important;">
                    <div class="flex gap-8 overflow-x-auto w-max">
                        <?php displayProductsByCategory($conn, "Suspension & Steering"); ?>
                    </div>
                </div>
                <button
                    class="right-btn absolute right-[-15px] top-[50%] translate-y-[-50%] bg-white  border-black border-2 rounded-full w-[40px] h-[40px]"><i
        ...
        <!-- popular brands -->
        <section class="popular-brands col-span-2 bg-white ml4 p-4 m-auto">
            ...
            <div class="pupular-con relative">
                ...
                <div class="w-100 border-[red] border-0 overflow-hidden">
                    <div class="pb-con flex gap-8 overflow-x-auto w-max">
                        <a href="" class="w-32">
                            <img src="../img/nike sho.jpg" width="128px" height="128px" alt="">
                        </a>
                        <a href="" class="w-32">
                            <img src="../img/adidas.jpeg" width="128px" height="128px" alt="">
                        </a>
                        <a href="" class="w-32">
                            <img src="../img/gucci.jpeg" width="128px" height="128px" alt="">
                        </a>
                        <a href="" class="w-32">
                            <img src="../img/honda.jpeg" width="128px" height="128px" alt="">
                        </a>
                        <a href="" class="w-32">
                            <img src="../img/toyota.jpeg" width="128px" height="128px" alt="">
                        </a>
                        <a href="" class="w-32">
                            <img src="../img/levis.jpeg" width="128px" height="128px" alt="">
                        </a>
                        <a href="" class="w-32">
                            <img src="../img/parss.jpg" width="128px" height="128px" alt="">
                        </a>
                        <a href="" class="w-32">
                            <img src="../img/parss.jpg" width="128px" height="128px" alt="">
                        </a>
        ...
        <!-- Lighting & Electrical -->
        <section class="Bargains-galore col-span-2 bg-white mt4 p-4 -[78vw] m-auto">
            <h2 class="font-bold mb-4">Lighting & Electrical</h2>
            <div class="pupular-con relative">
                <button
                    class="left-btn absolute left-[-15px] top-[50%] translate-y-[-50%] bg-white  border-black border-2 rounded-full w-[40px] h-[40px]"><i
                        class="fa-solid fa-arrow-left text-xl"></i></button>
                <div class="w-100 border-[red] border-0 overflow-hidden" style="width: 78vw !important;">
                    <div class="flex gap-8 overflow-x-auto w-max">
                        <?php displayProductsByCategory($conn, "Car Electronics (Speakers, Cameras, etc.)"); ?>
                    </div>
                </div>
                <button
                    class="right-btn absolute right-[-15px] top-[50%] translate-y-[-50%] bg-white  border-black border-2 rounded-full w-[40px] h-[40px]"><i
        ...
        <section class="pickup col-span-2 bg-white mt4 p-4 -[78vw] m-auto">
            <h2 class="font-bold mb-4"> Interior Accessories</h2>
            <div class="pupular-con relative">
                <button
                    class="left-btn absolute left-[-15px] top-[50%] translate-y-[-50%] bg-white  border-black border-2 rounded-full w-[40px] h-[40px]"><i
                        class="fa-solid fa-arrow-left text-xl"></i></button>
                <div class="w-100 border-[red] border-0 overflow-hidden" style="width: 78vw !important;">
                    <div class="flex gap-8 overflow-x-auto w-max">
                        <?php displayProductsByCategory($conn, "Interior Accessories (Seat Covers, Dashboard, etc.)"); ?>
                    </div>
                </div>
                <button
                    class="right-btn absolute right-[-15px] top-[50%] translate-y-[-50%] bg-white  border-black border-2 rounded-full w-[40px] h-[40px]"><i
        ...
        <section class="rare-items col-span-2 bg-white mt4 p-4 -[78vw] m-auto">
            <h2 class="font-bold mb-4">Exterior Accessories</h2>
            <div class="pupular-con relative">
                <button
                    class="left-btn absolute left-[-15px] top-[50%] translate-y-[-50%] bg-white  border-black border-2 rounded-full w-[40px] h-[40px]"><i
                        class="fa-solid fa-arrow-left text-xl"></i></button>
                <div class="w-100 border-[red] border-0 overflow-hidden" style="width: 78vw !important;">
                    <div class="flex gap-8 overflow-x-auto w-max">
                        <?php displayProductsByCategory($conn, "Exterior Accessories (Fog Lights, Wipers, etc.)"); ?>
                    </div>
                </div>
                <button
                    class="right-btn absolute right-[-15px] top-[50%] translate-y-[-50%] bg-white  border-black border-2 rounded-full w-[40px] h-[40px]"><i
