    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-10">
            ...
            <div class="grid grid-cols-1 gap-10 md:col-span-2 lg:col-span-1">
                ...
                <div>
                    <h3 class="text-xl font-serif font-bold text-gray-900 mb-6">Social & Contact</h3>
                    
                    <!-- Social Icons (Using SVG placeholders for Instagram, Facebook, etc.) -->
                    <div class="flex space-x-4 mb-8">
                        <!-- Instagram -->
                        <a href="#" class="text-gray-700 hover:text-gray-900 transition duration-150">
                        ...
                        <!-- Facebook -->
                        <a href="#" class="text-gray-700 hover:text-gray-900 transition duration-150">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.875v-6.987H8.252V12h2.186V9.465c0-2.031 1.237-3.136 3.053-3.136.877 0 1.637.155 1.867.224v2.103h-1.246c-1.218 0-1.45.578-1.45 1.419V12h2.597l-.42 2.788h-2.177v7.26C18.343 21.128 22 16.991 22 12z"></path></svg>
                        </a>
                        <!-- Youtube (Simulated) -->
                        <a href="#" class="text-gray-700 hover:text-gray-900 transition duration-150">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="M20.8 5.6c-.3-.9-1-1.6-1.9-1.9C17.2 3 12 3 12 3s-5.2 0-6.9.7c-.9.3-1.6 1-1.9 1.9C3 7 3 12 3 12s0 5.2.7 6.9c.3.9 1 1.6 1.9 1.9C6.8 21 12 21 12 21s5.2 0 6.9-.7c.9-.3 1.6-1 1.9-1.9.7-1.7.7-6.9.7-6.9s0-5.2-.7-6.9zM10 16.5V7.5L16 12l-6 4.5z"></path></svg>
                        </a>
                        <!-- Placeholder icon for another social site (e.g., Pinterest/TikTok) -->
                        <a href="#" class="text-gray-700 hover:text-gray-900 transition duration-150">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm0-4h-2V7h2v8z"></path></svg>
                        </a>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative flex items-center border-b border-gray-400 focus-within:border-gray-900 transition duration-300">
                            <input type="email" id="email-subscribe" placeholder="Your Email Address" 
                                   class="w-full bg-transparent py-2 text-gray-900 placeholder-gray-500 focus:outline-none text-sm">
                            <button class="p-1 text-gray-700 hover:text-gray-900 transition duration-150">
                                <!-- Right Arrow Icon -->
