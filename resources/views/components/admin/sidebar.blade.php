<aside class="w-[18vw] bg-gray-900 text-white flex flex-col">
      <div class="p-6 text-2xl font-bold border-b border-gray-800">MJCheezain</div>
      <nav class="flex-1 overflow-y-auto scrollbar-hide">
        <ul class="space-y-2 p-4">
          <li><a href="/admin/dashboard" class="block py-2 px-4 rounded bg-gray-800 ad-active"><i class="fa-solid fa-house"></i> Dashboard</a></li>
          ...
          <li><a href="/admin/category-suggestions" class="block py-2 px-4 rounded hover:bg-gray-800"><i class="fa-solid fa-tags"></i> Category Requests</a></li>
